...
export function HomeButton({
  ...
  const base =
    "shine-sweep press-feedback inline-flex items-center justify-center border-[3px] px-5 py-3 font-[family-name:var(--font-inter)] text-xs font-black uppercase tracking-[0.18em] transition-transform duration-200 hover:-translate-y-0.5 sm:text-sm";
  const styles =
    variant === "primary"
