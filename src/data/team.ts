      ...
      [
        {
          ...
          bio: "Leading the App Dev sub-team from concept to deployment, driving sprint planning and code reviews. They bridge the gap between ideas and working products, keeping every build on time and on target.",
      ...
      [
        {
          ...
          name: "UI/UX Managers",
          role: "UI/UX Managers",
          bio: "Driving the UX vision and design process across Techverse projects, ensuring every product is intuitive and delightful. They champion user research and translate insights into clean, consistent interfaces.",
          image: "/images/managers/Tech.JPG",
          domain: "techverse",
          subDomain: "ui-ux",
          Linkedin: "",
      ...
      [
        {
          ...
          bio: "Orchestrating every detail behind Cherry+ events — from venue logistics to day-of coordination — ensuring each experience runs flawlessly. They rally the team, manage timelines, and make sure no moment is left to chance.",
      ...
      [
        {
          ...
          bio: "Building and nurturing relationships with sponsors, brands, and external partners that fuel Cherry+ Network's growth. They negotiate collaborations, draft proposals, and represent the network's value to the wider industry.",
      ...
      [
        {
          ...
          bio: "Owning the visual identity of Cherry+ Network and ensuring every creative asset — from posters to social content — speaks the same bold language. They set the design bar, provide feedback, and keep the brand unmistakably consistent.",
      ...
      [
        {
          ...
          bio: "Hands-on contributors building mobile features, debugging, and learning fast in a real-world environment. Every sprint sharpens their skills and adds another layer to the products that power Cherry+.",
      ...
      [
        {
          ...
          bio: "Collaborating on frontend builds, responsive layouts, and web features that reach the whole community. They bring fresh perspectives and a drive to ship work that looks great and performs even better.",
          image: "/images/assocs/Tech.JPG",
          domain: "techverse",
          subDomain: "web-dev",
        },
      ...
      [
        {
          ...
          bio: "Crafting wireframes, prototypes, and polished UI components that make every Cherry+ product a pleasure to use. They blend creativity with empathy, turning feedback into designs that just feel right.",
          image: "/images/assocs/Tech.JPG",
          domain: "techverse",
          subDomain: "ui-ux",
        },
      ...
      [
        {
          ...
          bio: "The engine room behind every Cherry+ event — setting up, coordinating on the day, and making sure attendees walk away with memories worth talking about. They thrive under pressure and love turning plans into reality.",
      ...
      [
        {
          ...
          bio: "Supporting outreach, sponsor follow-ups, and partnership documentation that keeps the network's external relationships strong. They are the first point of contact for brands looking to collaborate with Cherry+.",
      ...
      [
        {
          ...
          bio: "Bringing Cherry+ stories to life through graphics, motion, and content that stop the scroll. They dive into every brief with curiosity and deliver visuals that make the community proud to be part of the network.",
